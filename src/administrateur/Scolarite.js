...
const Scolarite = () => {
    ...
    const handleSubmit = async(e)=>{
        ...
        try {
            const response = await axios.post('/saveuser',JSON.stringify({
                userName,
                nom,
                prenom,
                dateDeNaissance,
    ...
    <div className='grid grid-cols-5 gap-1 '>
        ...
        >
            <div className='flex justify-center mb-8 inline-block border border-blue-500 rounded py-1 px-1 bg-blue-500 text-white'>
                <Link to='#'>ajouter un agent de scolarite</Link>
            </div>
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                onChange={(e)=>setUserName(e.target.value)}
                         ...
                         ref={userRef}
                />
                <p id='username' className={userName && usernameFocus && !validUsername ? 'visible' : 'invisible'}>
                            username invalide
                </p>
                </div>
